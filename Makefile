create:
	...
	GTC_VERSION=${GTC_VERSION} WORKSPACE_PARENT=${BUILD_WORKSPACE_PARENT} WORKSPACE=${BUILD_WORKSPACE} PROJECT=${PROJECT} docker-compose -f docker-compose.client.yml up -d --remove-orphans api
	GTC_VERSION=${GTC_VERSION} WORKSPACE_PARENT=${BUILD_WORKSPACE_PARENT} WORKSPACE=${BUILD_WORKSPACE} PROJECT=${PROJECT} docker-compose -f docker-compose.client.yml up -d --remove-orphans soap.api
	GTC_VERSION=${GTC_VERSION} WORKSPACE_PARENT=${BUILD_WORKSPACE_PARENT} WORKSPACE=${BUILD_WORKSPACE} PROJECT=${PROJECT} docker-compose -f docker-compose.client.yml up --remove-orphans client
