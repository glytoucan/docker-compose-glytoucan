create:
	GTC_VERSION=${GTC_VERSION} docker-compose -f docker-compose.clean.yml rm
	...
	GTC_VERSION=${GTC_VERSION} docker-compose -f docker-compose.build.yml rm
	...
	GTC_VERSION=${GTC_VERSION} docker-compose -f docker-compose.copy.yml rm
